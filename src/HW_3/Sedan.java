...
public class Sedan extends Car implements iGasStation {
     ...
     */
    public Sedan(String brand, String model, Color color, String bodyType, int wheelsCount, String fuelType, String transmissionType, float engineCapacity, iGasStation gasStation) {
