...
public class LandCruiser extends Car implements iGasStation {
     ...
     */
    public LandCruiser(String brand, String model, Color color, String bodyType, int wheelsCount, String fuelType, String transmissionType, float engineCapacity, iGasStation gasStation) {
